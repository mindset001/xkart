...
const KidsModal: FC<ModalProps> = ({ onCancel, ...props }) => {

    const [quantity, setQuantity] = useState(1);
    const pricePerTicket = 10000; // Price for one ticket
                ...
                <main >
                    ...
                    <div className="flex">
                        <div className="text-center">
                            ...
                            <p className="text-[#EF3133] text-[18px] font-[600] my-[2px]">VIP Ticket (kids)</p>
                        </div>

                    </div>
                    <div>
                        <p className=" text-center text-[#667085] text-[12px] font-[400] italic">Only available for children under the age of 16</p>
                    </div>
